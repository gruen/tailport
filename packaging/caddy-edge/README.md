...
public hostname (`https://app.example.com`) over your tailnet — the `d`
(publish, moved from `p` under 58ws, which reversed vzj4's earlier `P`/`p`
swap) path, kata v1z5. It mirrors [`packaging/aur/`](../aur/) and
